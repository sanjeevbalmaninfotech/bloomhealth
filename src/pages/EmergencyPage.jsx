...
const EmergencyPage = () => {
  ...
  const emergencyProcedures = [
    {
      ...
      description:
        'Upon arrival, patients undergo immediate triage assessment to prioritize treatment based on severity of condition.',
    ...
    },
    {
      ...
      description:
        'If needed, our on-call specialists are available 24/7 for immediate consultation and advanced treatment procedures.',
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30'>
      {/* Hero Section */}
      <section className='relative flex justify-center px-2 py-8'>
          ...
          <div className='max-w-4xl w-full mx-auto'>
            ...
            <div className='p-6 bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-200 text-center mb-6'>
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
                ...
                <a
                  ...
                  style={{
                    background: 'linear-gradient(to right, hsl(203, 80%, 52%), hsl(203, 80%, 62%))',
                  }}
                >
            ...
            <div className='hide-above-1280 grid gap-6 md:hidden'>
              {emergencyContacts.map((contact, index) => (
                <div
                  key={index}
                  className='p-6 bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-200'
                >
        ...
        <div className='container mx-auto'>
          <div className='max-w-4xl mx-auto text-center mb-10'>
            ...
            <p className='text-lg text-gray-600 leading-relaxed'>
              When you arrive at our emergency department, here's exactly what happens to ensure you
              receive the best possible care as quickly as possible.
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            {emergencyProcedures?.map((procedure, index) => (
              <div
                key={index}
                className='p-6 bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-200 hover:shadow-3xl transition-all duration-300'
              >
            ...
            {emergencyServices.map((service, index) => (
              ...
              >
                <div className='flex flex-col items-center text-center'>
                  ...
                  <span
                    className='text-sm font-semibold px-4 py-2 rounded-full bg-blue-50 border border-blue-100'
                    style={{ color: 'hsl(203, 80%, 42%)' }}
                  >
                    {service.details}
                  </span>
                ...
                <div className='space-y-4'>
                  <div className='flex items-center space-x-4'>
                    ...
                    <div>
                      ...
                      <a
                        href='tel:999'
                        className='text-rose-500 hover:text-rose-600 font-bold text-xl'
                      >
                        Call 999
                      </a>
                    </div>
              ...
              <div className='p-8 bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-200'>
                ...
                <div className='space-y-4'>
                  ...
                  <a
                    ...
                    style={{
                      background:
                        'linear-gradient(to right, hsl(203, 80%, 42%), hsl(203, 80%, 52%))',
                    }}
                  >
                    <Phone className='h-6 w-6' />
        ...
        <div className='container mx-auto'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg text-gray-600 mb-12 leading-relaxed'>
              Knowing what to expect and how to communicate during an emergency can save valuable
              time and potentially save lives. Here's what our emergency team needs from you.
            </p>
