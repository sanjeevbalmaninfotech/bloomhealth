...
const TravelMedicineAndVaccinations = () => {
  ...
  return (
    <Department
      ...
      Whether you need malaria prevention, altitude medication  or routine and travel-specific vaccines, we are here to support your health before, during and after your journey.'
      services={[
