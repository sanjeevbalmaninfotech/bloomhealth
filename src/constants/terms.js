export const pdfSections = [
    ...
    },
    {
      ...
      description: 'You give us permission to securely share your relevant information with your General Practitioner (GP) — such as medical records or reports — to support your care.',
      pdfUrl: '/documents/1.pdf',
      icon: '🍪',
